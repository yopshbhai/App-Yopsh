...
function requestOTP() {
    var email = $("#email").val();
    fetch('https://script.google.com/macros/s/AKfycbxbD2KGAdZ_ij34saXUKVmM_DNXxGI1z9e4PiPfc2EtNl-4YRZw9CHeikN9v70AnKRB/exec?requestOTP=true&email='+email)
        .then(response => {
            if (response.ok) {
...
function verifyOTP() {
    ...
    fetch('https://script.google.com/macros/s/AKfycbxbD2KGAdZ_ij34saXUKVmM_DNXxGI1z9e4PiPfc2EtNl-4YRZw9CHeikN9v70AnKRB/exec?verifyOTP=true&email='+email+'&otp='+otpEntered)
        .then(response => {
            if (response.ok) {
                return response.text();
            } else {
...
function saveAdditionalDetails() {
    ...
    uploadImage(imageFile).then(imageUrl => {
        ...
        fetch('https://script.google.com/macros/s/AKfycbxbD2KGAdZ_ij34saXUKVmM_DNXxGI1z9e4PiPfc2EtNl-4YRZw9CHeikN9v70AnKRB/exec?email='+email+'&username='+username+'&name='+name+'&password='+password+'&birthdate='+birthdate+'&age='+age+'&mobile='+mobile+'&gender='+gender+'&countryCode='+countryCode+'&imageUrl='+encodeURIComponent(imageUrl))
            .then(response => {
                if (response.ok) {
