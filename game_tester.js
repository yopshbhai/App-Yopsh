let allData = [];
	...
	function fetchData(role) {
		showloaderGam(role);
		fetch(role === 'gamer'
			? 'https://script.google.com/macros/s/AKfycbxSn8k0XQE4F4Gjf_oQPujDDGDthhjD-S52k2fnU-we2BhVCrAm0ljm-LW8EenBi6UN/exec'
			: 'https://script.google.com/macros/s/AKfycbxQZnNbE6k_VxqOb8sCdDQp5yfeaaVhWS-o_qYStY6Zlj36fc6PQNNqSQud6oO1BrEB/exec', {
			method: 'POST'
		})
